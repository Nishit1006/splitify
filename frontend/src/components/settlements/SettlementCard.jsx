            ...
            <Card hover>
                <CardContent className="py-4">
                        ...
                        <div className="flex items-center gap-3 flex-shrink-0">
                            ...
                            {isPayer && (
                                <button
                                    ...
                                    className="p-1.5 rounded-lg text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors ml-1"
                    ...
                    {settlement.referenceNote && (
                        <div className="mt-3 text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-800/50 p-2 rounded-lg border border-gray-100 dark:border-gray-800">
                            "{settlement.referenceNote}"
                        </div>
                    )}
                    ...
                    {settlement.proof && (
                        <div className="mt-3">
                            <button
                                ...
                                className="group flex items-center gap-2 text-xs font-medium text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300 transition-colors"
                            >
                                <div className="w-12 h-12 rounded-lg overflow-hidden border-2 border-gray-200 dark:border-gray-700 group-hover:border-brand-400 dark:group-hover:border-brand-500 transition-colors">
                                    <img
